...
<head>
	...
	<title>KING CAFE<?php echo $pagedesc ?></title>

	<link href="foto/logo (2).png" rel="icon" type="images/x-icon">
			...
			<div class="row">
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 3px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05); box-shadow: 0 1px 1px rgba(0,0,0,.05)">
					<div class="row">
						<div class="col-lg-12">
							<br/>
							<center><img src="foto/logo (2).png" width="120" height="120"></center>
							<b><h2 class="text-center">KING CAFE</h2></b>
						</div>
					</div><!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<br><center><p>POSTED BY <a href='https://rajaganteng.com/' title='StokCoding.com' target='_blank'>Dicodean.com</a></p></center>
